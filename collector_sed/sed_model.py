...
class SedimentBed:
    ...
    def settle(self, settle_thickness):
...
class SedCell:
    ...
    def _get_sediment_mass(self, cv: CollectorParams):
        ...
        total_mass = (cut_settled * self.sed_settled_density) + (cut_bed * self.sed_base_density)
        ...
        while passed_sediment:
            ...
            for i in range(self.number_of_cells):
                ...
                if cell.sed_to_pass_left > self.mass_lower_limit:
                    ...
                    try:
                        self.cells[i-1].add_sediment(cell.sed_to_pass_left, 'left')
                    except IndexError:
                        pass
                ...
                if cell.sed_to_pass_right > self.mass_lower_limit:
                    ...
                    try:
                        self.cells[i+1].add_sediment(cell.sed_to_pass_right, 'right')
                    except IndexError:
                        pass
